...
function Kt(e, t) {
  ...
  if (((w += S), (k.precision = w), (r = Ae(L)), (n = r.charAt(0)), (o = Z(C)), Math.abs(o) < 15e14)) {
    for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); ) ((C = C.times(e)), (r = Ae(C.d)), (n = r.charAt(0)), R++)
...
var Ol = me((U) => {
  ...
  function rd(e = 32) {
    if (Mt.crypto && typeof Mt.crypto.getRandomValues == 'function') return Mt.crypto.getRandomValues(new Uint8Array(e))
      ...
      case 'field':
        {
          ...
          else throw new G(`Missing data field (Value): '${s}'; node: ${JSON.stringify(o)}; data: ${JSON.stringify(e)}`)
        }
        break
      default:
      ...
      return (
        e.activeProvider === void 0 || Ro[e.activeProvider] === void 0
          ? ((n = (async () => {
              ...
              if (o == null) throw new F('The loaded wasm module was unexpectedly `undefined` or `null` once loaded', t)
